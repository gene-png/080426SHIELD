...
> Filled in across phases. This file lands its first real content during Phase 2 (intake) and grows phase-by-phase. Current state: placeholder.

## What you'll see as a client
...
5. **Executive view** — leadership sees a minimalist KPI-focused summary; operational staff see drill-down telemetry.
