...
/**
 * POST /api/proxy/csf/deliverables/{id}/release - release a finalized
 * deliverable to the client (issue 4).
 *
 * This route did not exist. releaseCsfDeliverable() in the web client lib
...
export async function POST(
  ...
  return proxyJson(`/csf/deliverables/${params.id}/release`, {
    method: "POST",
  });
}
