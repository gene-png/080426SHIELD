...
/**
 * POST /api/proxy/zt/deliverables/{id}/release - release a finalized
 * deliverable to the client (issue 4).
 *
 * This route did not exist. releaseZtDeliverable() in the web client lib
...
export async function POST(
  ...
  return proxyJson(`/zt/deliverables/${params.id}/release`, {
    method: "POST",
  });
}
