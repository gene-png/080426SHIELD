...
/**
 * POST /api/proxy/tech-debt/deliverables/{id}/release - release a finalized
 * deliverable to the client (issue 4).
 *
 * This route did not exist. releaseDeliverable() in the web client lib
...
export async function POST(
  ...
  return proxyJson(`/tech-debt/deliverables/${params.id}/release`, {
    method: "POST",
  });
}
